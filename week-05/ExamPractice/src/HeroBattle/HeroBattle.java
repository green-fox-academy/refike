...
public class HeroBattle {
    ...
    public static void main(String[] args) {
        ...
        battle(heroes);
        log(heroes);
        System.out.println(heroes.get(1).getMotivationLevel());
        System.out.println(heroes.get(2).getMotivationLevel());
        System.out.println(heroes.get(3).getMotivationLevel());
        System.out.println(heroes.get(4).getMotivationLevel());
    }
